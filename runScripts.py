...
def runScript(nDevices, packetDelay, simulationTime, radius, packetSize, dataRate):
    ...
    try:
        ipc = "nDevices: " + nDevices + ", packetDelay: " + packetDelay + ", simulationTime: " + simulationTime + ", radius: " + radius + ", packetSize: " + packetSize + ", dataRate: " + dataRate + ", " + returnThing.stdout.decode('utf-8').splitlines()[0].split()[2] + ", " + returnThing.stdout.decode('utf-8').splitlines()[1].split()[4] + ", " + returnThing.stdout.decode('utf-8').splitlines()[1].split()[4] + "\n"
    except:
        print("error")
        ipc = "error"
    return ipc
